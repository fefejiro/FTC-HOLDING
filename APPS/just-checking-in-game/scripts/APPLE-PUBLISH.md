...
1. Confirm the uploaded build is `1.2.0 (5)` in App Store Connect.
...
5. After Apple approval and release, verify the public listing shows `1.2.0` and install it on a clean physical iPhone.
