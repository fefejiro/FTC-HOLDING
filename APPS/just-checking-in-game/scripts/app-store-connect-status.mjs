...
const builds = await request("builds?filter[app]=6799443182&sort=-uploadedDate&limit=20&fields[builds]=version,uploadedDate,processingState,buildAudience,expirationDate,usesNonExemptEncryption,preReleaseVersion");
const versions = await request("appStoreVersions?filter[app]=6799443182&filter[platform]=IOS&sort=-createdDate&limit=10&fields[appStoreVersions]=versionString,appStoreState,releaseType,createdDate,platform,downloadable,build");
