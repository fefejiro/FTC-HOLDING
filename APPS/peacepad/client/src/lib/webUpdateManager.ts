export const WEB_BUILD_META_PATH = "/_peacepad/build-meta.json";
export const WEB_BUILD_ID_KEY = "peacepad_web_build_id";
export const WEB_UPDATE_DEFERRED_KEY = "peacepad_update_deferred";
export const WEB_UPDATE_FORCE_AFTER_KEY = "peacepad_update_force_after";
export const WEB_PENDING_BUILD_ID_KEY = "peacepad_pending_web_build_id";
