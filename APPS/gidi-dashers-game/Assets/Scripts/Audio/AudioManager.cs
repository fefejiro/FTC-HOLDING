...
namespace GidiDashers.Audio
{
    ...
    public class AudioManager : MonoBehaviour
    {
        ...
        private void OnStateChanged(GidiDashers.Core.GameState state)
        {
            switch (state)
            {
                case GidiDashers.Core.GameState.Menu:    PlayMusic(menuMusic); break;
                case GidiDashers.Core.GameState.Playing: PlayMusic(gameMusic);  break;
                case GidiDashers.Core.GameState.Dead:    PlaySFX(deathSFX);    break;
            }
        }
