...
if (
  ...
  || playStoreInternalProfile?.android?.credentialsSource !== "remote"
) {
...
if (
  ...
  || playStoreProductionProfile?.android?.credentialsSource !== "remote"
) {
...
if (
  ...
  || productionDeviceApkProfile?.android?.credentialsSource !== "remote"
) {
...
for (const expectedReleaseValue of ["ca.peacepad.family", "6793350735", "2.0.3", "14", "52", "testflight-internal", "appstore-production", "staging-simulator-dual", "playstore-internal", "playstore-production"]) {
