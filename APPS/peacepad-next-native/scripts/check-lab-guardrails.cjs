...
for (const expectedReleaseValue of ["ca.peacepad.family", "6793350735", "2.0.3", "14", "55", "testflight-internal", "appstore-production", "staging-simulator-dual", "playstore-internal", "playstore-production"]) {
