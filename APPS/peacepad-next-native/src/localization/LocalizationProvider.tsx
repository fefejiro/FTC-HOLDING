...
const messages = {
  en: {
    ...
    ,"runtime.connectionReady": "{family} is ready. Share a single-use code, then check again after it is accepted.", "runtime.continueSolo": "Continue without a co-parent", "runtime.inviteLater": "Invite a co-parent later", "runtime.createFamilyWhenReady": "Set up family connection later", "runtime.soloTitle": "Your private PeacePad space", "runtime.soloBody": "{family} is ready for you. You can explore your private space now and connect a co-parent whenever you are ready.", "runtime.soloOnboardingBody": "You can explore PeacePad privately now. Create a family space or connect a co-parent whenever you are ready.", "runtime.soloPrivateTitle": "Private until you connect", "runtime.soloPrivateBody": "Nothing is shared with another parent yet. Messaging, shared calendars, and calls become available after an authorized family member joins.", "runtime.inviteExpiry": "Expires in 72 hours. Do not use real family information in staging.",
    "runtime.checkConnection": "Check connection", "runtime.createAccount": "Create account", "runtime.forgotPassword": "Forgot password?", "runtime.backToSignIn": "Back to sign in", "runtime.createAccountTitle": "Create your PeacePad account", "runtime.createAccountBody": "Use your email to create a private family account.", "runtime.resetPasswordTitle": "Reset your password", "runtime.resetPasswordBody": "We will email you a secure reset link.", "runtime.createAccountAction": "Create account", "runtime.resetPasswordAction": "Send reset link", "runtime.checkEmailForVerification": "Check your email to verify your account.", "runtime.resetEmailSent": "Reset link sent. Check your email.", "runtime.passwordUpdated": "Password updated. Sign in again.", "runtime.updatePasswordAction": "Update password", "runtime.resetUnavailable": "We could not complete that password request. Try again.", "runtime.resetLinkInvalid": "This reset link is invalid or expired.", "runtime.newPassword": "New password", "runtime.confirmPassword": "Confirm password", "runtime.passwordMismatch": "Passwords do not match.", "runtime.introLogo": "PeacePad logo", "runtime.skip": "Skip", "runtime.next": "Next", "runtime.getStarted": "Get started"
  ...
  fr: {
    ...
    ,"runtime.connectionReady": "L’espace {family} est prêt. Partagez un code à usage unique, puis vérifiez de nouveau après son acceptation.", "runtime.continueSolo": "Continuer sans coparent", "runtime.inviteLater": "Inviter un coparent plus tard", "runtime.createFamilyWhenReady": "Configurer le lien familial plus tard", "runtime.soloTitle": "Votre espace PeacePad privé", "runtime.soloBody": "{family} est prêt. Vous pouvez explorer votre espace privé maintenant et connecter un coparent quand vous serez prêt.", "runtime.soloOnboardingBody": "Vous pouvez explorer PeacePad en privé. Créez un espace familial ou connectez un coparent quand vous serez prêt.", "runtime.soloPrivateTitle": "Privé jusqu’à la connexion", "runtime.soloPrivateBody": "Rien n’est encore partagé avec un autre parent. Les messages, calendriers partagés et appels deviennent disponibles lorsqu’un membre familial autorisé rejoint l’espace.", "runtime.inviteExpiry": "Expire dans 72 heures. N’utilisez aucune information familiale réelle dans l’environnement de test.",
    "runtime.checkConnection": "Vérifier la connexion", "runtime.createAccount": "Créer un compte", "runtime.forgotPassword": "Mot de passe oublié ?", "runtime.backToSignIn": "Retour à la connexion", "runtime.createAccountTitle": "Créez votre compte PeacePad", "runtime.createAccountBody": "Utilisez votre courriel pour créer un compte familial privé.", "runtime.resetPasswordTitle": "Réinitialiser votre mot de passe", "runtime.resetPasswordBody": "Nous vous enverrons un lien sécurisé.", "runtime.createAccountAction": "Créer un compte", "runtime.resetPasswordAction": "Envoyer le lien", "runtime.checkEmailForVerification": "Vérifiez votre courriel pour confirmer votre compte.", "runtime.resetEmailSent": "Lien envoyé. Consultez votre courriel.", "runtime.passwordUpdated": "Mot de passe mis à jour. Reconnectez-vous.", "runtime.updatePasswordAction": "Mettre à jour", "runtime.resetUnavailable": "Impossible de réinitialiser le mot de passe. Réessayez.", "runtime.resetLinkInvalid": "Ce lien est invalide ou expiré.", "runtime.newPassword": "Nouveau mot de passe", "runtime.confirmPassword": "Confirmer le mot de passe", "runtime.passwordMismatch": "Les mots de passe ne correspondent pas.", "runtime.introLogo": "Logo PeacePad", "runtime.skip": "Passer", "runtime.next": "Suivant", "runtime.getStarted": "Commencer"
  ...
  es: {
    ...
    ,"runtime.connectionReady": "El espacio {family} está listo. Comparte un código de un solo uso y vuelve a comprobar después de que se acepte.", "runtime.continueSolo": "Continuar sin copadre", "runtime.inviteLater": "Invitar a un copadre más tarde", "runtime.createFamilyWhenReady": "Configurar la conexión familiar más tarde", "runtime.soloTitle": "Tu espacio privado de PeacePad", "runtime.soloBody": "{family} está listo. Puedes explorar tu espacio privado ahora y conectar a un copadre cuando quieras.", "runtime.soloOnboardingBody": "Puedes explorar PeacePad en privado. Crea un espacio familiar o conecta a un copadre cuando quieras.", "runtime.soloPrivateTitle": "Privado hasta que conectes", "runtime.soloPrivateBody": "Todavía no se comparte nada con otro progenitor. Los mensajes, calendarios compartidos y llamadas estarán disponibles cuando se una un miembro familiar autorizado.", "runtime.inviteExpiry": "Caduca en 72 horas. No uses información familiar real en el entorno de pruebas.",
    "runtime.checkConnection": "Comprobar conexión", "runtime.createAccount": "Crear cuenta", "runtime.forgotPassword": "¿Olvidaste tu contraseña?", "runtime.backToSignIn": "Volver a iniciar sesión", "runtime.createAccountTitle": "Crea tu cuenta de PeacePad", "runtime.createAccountBody": "Usa tu correo para crear una cuenta familiar privada.", "runtime.resetPasswordTitle": "Restablecer contraseña", "runtime.resetPasswordBody": "Te enviaremos un enlace seguro.", "runtime.createAccountAction": "Crear cuenta", "runtime.resetPasswordAction": "Enviar enlace", "runtime.checkEmailForVerification": "Revisa tu correo para verificar tu cuenta.", "runtime.resetEmailSent": "Enlace enviado. Revisa tu correo.", "runtime.passwordUpdated": "Contraseña actualizada. Inicia sesión de nuevo.", "runtime.updatePasswordAction": "Actualizar contraseña", "runtime.resetUnavailable": "No pudimos restablecer la contraseña. Inténtalo de nuevo.", "runtime.resetLinkInvalid": "Este enlace no es válido o ha caducado.", "runtime.newPassword": "Nueva contraseña", "runtime.confirmPassword": "Confirmar contraseña", "runtime.passwordMismatch": "Las contraseñas no coinciden.", "runtime.introLogo": "Logotipo de PeacePad", "runtime.skip": "Omitir", "runtime.next": "Siguiente", "runtime.getStarted": "Comenzar"
