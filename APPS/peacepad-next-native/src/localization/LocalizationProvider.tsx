...
const messages = {
  en: {
    ...
    "more.title": "More", "more.family.title": "Co-parent coordination", "more.family.body": "Invite another parent or review a coordination invitation.",
    ...
    "support.title": "Help & Support", "support.quickHelp": "Find answers or contact the PeacePad support team.",
    "support.helpCenter": "Help center", "support.contact": "Contact support", "support.privacy": "Privacy", "support.safety": "Safety",
    "support.diagnostic": "Diagnostic ID: {id}", "support.diagnosticLoading": "Preparing diagnostic ID...", "support.openError": "PeacePad could not open that link.",
    "profile.title": "Profile", "profile.body": "Choose the name shown to your connected family.", "profile.name": "Display name",
    "profile.save": "Save profile", "profile.saving": "Saving profile...", "profile.saved": "Profile saved.", "profile.error": "PeacePad could not update your profile.",
    "personality.title": "Communication profile", "personality.body": "Optional. Choose a type only if you already know it. PeacePad never infers a type about you or the other parent, and this is not a diagnosis.", "personality.notSure": "Not sure yet", "personality.saving": "Saving...", "personality.saved": "Communication profile saved.", "personality.error": "PeacePad could not update your communication profile.", "personality.optionHint": "Select this optional communication profile.",
    "more.introduction.title": "Replay introduction", "more.introduction.body": "See the three short PeacePad welcome screens again.",
    "notifications.title": "Notifications", "notifications.enable": "Turn on message, calendar, and incoming-call alerts.",
    "notifications.enabled": "Notifications are on. Tap to turn them off.", "notifications.denied": "Notifications are off in this device's settings.",
    "notifications.unavailable": "Notifications are temporarily unavailable.", "notifications.updating": "Updating notification settings...",
    ...
    "account.leaveFamily": "Leave this family", "account.leaveFamilyBody": "Remove your access to this family space.",
    "account.leaveFamilyTitle": "Leave this family?", "account.leaveFamilyWarning": "You will lose access. Shared coordination history will remain available to other authorized family members and will show you as a deactivated member.",
    "account.leavingFamily": "Leaving family...", "account.leaveFamilyConfirm": "Leave family",
    "invite.title": "Co-parent coordination", "invite.body": "Coordinate parenting around your children. Invite another parent or enter a code you received.", "invite.action": "Invitation action",
    ...
    "invite.connectedBody": "Your approved parenting connection is now active.", "invite.createCard": "Create a private invitation", "invite.createTitle": "Invite another parent",
    ...
    "runtime.signingIn": "Signing in...", "runtime.signIn": "Sign in", "runtime.chooseFamily": "Choose a parenting space", "runtime.chooseFamilyBody": "Select the parenting space you want to open.",
    "runtime.familyOption": "{family} - {role}", "runtime.createJoin": "Start with PeacePad", "runtime.createJoinBody": "Start privately, use an invitation you received, or connect another parent when you are ready.",
    "runtime.createFamilyTitle": "Connect another parent", "runtime.familyName": "Parenting space name", "runtime.createFamily": "Prepare a private invitation", "runtime.createConnectionBody": "PeacePad will prepare a private parenting space without asking you to label your family or relationship.", "runtime.enterInvite": "Have an invitation code?",
    ...
    ,"runtime.connectionReady": "Your parenting connection is ready. Share a single-use code only when you choose to.", "runtime.continueSolo": "Start on my own", "runtime.inviteLater": "Connect another parent later", "runtime.createFamilyWhenReady": "Connect another parent later", "runtime.soloTitle": "Your private PeacePad space", "runtime.soloBody": "Your space is ready. Use PeacePad privately and connect another parent only when you choose to.", "runtime.soloOnboardingBody": "Use PeacePad privately now. You can connect another parent later, but you do not need an invitation to get started.", "runtime.soloPrivateTitle": "Private by default", "runtime.soloPrivateBody": "Nothing is shared with another parent. You decide if and when to create a parenting connection.", "runtime.soloPauseTitle": "Pause before you send", "runtime.soloPauseBody": "Write a private draft, then share it in the channel that works for you.", "runtime.soloDraftLabel": "Private draft", "runtime.soloDraftPlaceholder": "Write what you want to say…", "runtime.soloShareDraft": "Share draft", "runtime.soloShareError": "PeacePad could not open sharing. Try again.", "runtime.inviteExpiry": "Expires in 72 hours. Do not use real family information in staging.",
    "runtime.checkConnection": "Check connection", "runtime.shareInvitation": "Share invitation", "runtime.shareInvitationTitle": "PeacePad invitation", "runtime.shareInvitationBody": "Review the invitation before you connect.", "runtime.shareInvitationCode": "Code: {code}", "runtime.shareInvitationError": "PeacePad could not open sharing. Use the code instead.", "runtime.createAccount": "Create account", "runtime.forgotPassword": "Forgot password?", "runtime.backToSignIn": "Back to sign in", "runtime.createAccountTitle": "Create your PeacePad account", "runtime.createAccountBody": "Use your email to create a private PeacePad account.", "runtime.resetPasswordTitle": "Reset your password", "runtime.resetPasswordBody": "We will email you a secure reset link.", "runtime.createAccountAction": "Create account", "runtime.resetPasswordAction": "Send reset link", "runtime.checkEmailForVerification": "Check your email to verify your account.", "runtime.resetEmailSent": "Reset link sent. Check your email.", "runtime.passwordUpdated": "Password updated. Sign in again.", "runtime.updatePasswordAction": "Update password", "runtime.resetUnavailable": "We could not complete that password request. Try again.", "runtime.resetLinkInvalid": "This reset link is invalid or expired.", "runtime.newPassword": "New password", "runtime.confirmPassword": "Confirm password", "runtime.passwordMismatch": "Passwords do not match.", "runtime.introLogo": "PeacePad logo", "runtime.skip": "Skip", "runtime.next": "Next", "runtime.getStarted": "Get started"
    ,"production.signInTitle": "Sign in to PeacePad", "production.signInBody": "Use your PeacePad account.",
    "production.regionCanada": "Canada", "production.email": "Email", "production.password": "Password",
    "production.createJoinBody": "Start privately, use an invitation you received, or connect another parent when you are ready.",
  ...
  fr: {
    ...
    "support.title": "Aide et soutien", "support.quickHelp": "Trouvez des réponses ou contactez l’équipe de soutien PeacePad.",
    "support.helpCenter": "Centre d’aide", "support.contact": "Contacter le soutien", "support.privacy": "Confidentialité", "support.safety": "Sécurité",
    "support.diagnostic": "Identifiant de diagnostic : {id}", "support.diagnosticLoading": "Préparation de l’identifiant de diagnostic...", "support.openError": "PeacePad n’a pas pu ouvrir ce lien.",
    "profile.title": "Profil", "profile.body": "Choisissez le nom affiché à votre famille connectée.", "profile.name": "Nom affiché",
    "profile.save": "Enregistrer le profil", "profile.saving": "Enregistrement du profil...", "profile.saved": "Profil enregistré.", "profile.error": "PeacePad n’a pas pu mettre à jour votre profil.",
    "personality.title": "Profil de communication", "personality.body": "Facultatif. Choisissez un type uniquement si vous le connaissez déjà. PeacePad ne déduit jamais votre type ni celui de l’autre parent, et ceci ne constitue pas un diagnostic.", "personality.notSure": "Pas encore sûr", "personality.saving": "Enregistrement...", "personality.saved": "Profil de communication enregistré.", "personality.error": "PeacePad n’a pas pu mettre à jour votre profil de communication.", "personality.optionHint": "Sélectionnez ce profil de communication facultatif.",
    "more.introduction.title": "Revoir l’introduction", "more.introduction.body": "Revoyez les trois courts écrans d’accueil de PeacePad.",
    "notifications.title": "Notifications", "notifications.enable": "Activez les alertes de messages, de calendrier et d’appels entrants.",
    "notifications.enabled": "Les notifications sont activées. Touchez pour les désactiver.", "notifications.denied": "Les notifications sont désactivées dans les réglages de cet appareil.",
    "notifications.unavailable": "Les notifications sont temporairement indisponibles.", "notifications.updating": "Mise à jour des notifications...",
    ...
    "account.leaveFamily": "Quitter cette famille", "account.leaveFamilyBody": "Retirez votre accès à cet espace familial.",
    "account.leaveFamilyTitle": "Quitter cette famille?", "account.leaveFamilyWarning": "Vous perdrez l’accès. L’historique de coordination partagé restera accessible aux autres membres autorisés et vous identifiera comme membre désactivé.",
    "account.leavingFamily": "Départ de la famille...", "account.leaveFamilyConfirm": "Quitter la famille",
    ...
    "invite.connectedBody": "Votre lien parental approuvé est maintenant actif.", "invite.createCard": "Créer une invitation privée", "invite.createTitle": "Inviter l’autre parent",
    ...
    "runtime.signingIn": "Connexion...", "runtime.signIn": "Se connecter", "runtime.chooseFamily": "Choisir un espace parental", "runtime.chooseFamilyBody": "Sélectionnez l’espace parental à ouvrir.",
    "runtime.familyOption": "{family} - {role}", "runtime.createJoin": "Commencer avec PeacePad", "runtime.createJoinBody": "Commencez en privé, utilisez une invitation reçue ou connectez l’autre parent quand vous le souhaitez.",
    "runtime.createFamilyTitle": "Connecter l’autre parent", "runtime.familyName": "Nom de l’espace parental", "runtime.createFamily": "Préparer une invitation privée", "runtime.createConnectionBody": "PeacePad préparera un espace parental privé sans vous demander de définir votre famille ou votre relation.", "runtime.enterInvite": "Vous avez un code d’invitation?",
    ...
    ,"runtime.connectionReady": "Votre lien parental est prêt. Partagez un code à usage unique seulement si vous le souhaitez.", "runtime.continueSolo": "Commencer de mon côté", "runtime.inviteLater": "Connecter l’autre parent plus tard", "runtime.createFamilyWhenReady": "Connecter l’autre parent plus tard", "runtime.soloTitle": "Votre espace PeacePad privé", "runtime.soloBody": "Votre espace est prêt. Utilisez PeacePad en privé et connectez l’autre parent seulement si vous le souhaitez.", "runtime.soloOnboardingBody": "Utilisez PeacePad en privé dès maintenant. Vous pourrez connecter l’autre parent plus tard, sans invitation obligatoire pour commencer.", "runtime.soloPrivateTitle": "Privé par défaut", "runtime.soloPrivateBody": "Rien n’est partagé avec l’autre parent. Vous décidez si et quand créer un lien parental.", "runtime.soloPauseTitle": "Faites une pause avant d’envoyer", "runtime.soloPauseBody": "Rédigez un brouillon privé, puis partagez-le dans le canal qui vous convient.", "runtime.soloDraftLabel": "Brouillon privé", "runtime.soloDraftPlaceholder": "Écrivez ce que vous voulez dire…", "runtime.soloShareDraft": "Partager le brouillon", "runtime.soloShareError": "PeacePad n’a pas pu ouvrir le partage. Réessayez.", "runtime.inviteExpiry": "Expire dans 72 heures. N’utilisez aucune information familiale réelle dans l’environnement de test.",
    "runtime.checkConnection": "Vérifier la connexion", "runtime.shareInvitation": "Partager l’invitation", "runtime.shareInvitationTitle": "Invitation PeacePad", "runtime.shareInvitationBody": "Consultez l’invitation avant de vous connecter.", "runtime.shareInvitationCode": "Code : {code}", "runtime.shareInvitationError": "PeacePad n’a pas pu ouvrir le partage. Utilisez le code à la place.", "runtime.createAccount": "Créer un compte", "runtime.forgotPassword": "Mot de passe oublié ?", "runtime.backToSignIn": "Retour à la connexion", "runtime.createAccountTitle": "Créez votre compte PeacePad", "runtime.createAccountBody": "Utilisez votre courriel pour créer un compte PeacePad privé.", "runtime.resetPasswordTitle": "Réinitialiser votre mot de passe", "runtime.resetPasswordBody": "Nous vous enverrons un lien sécurisé.", "runtime.createAccountAction": "Créer un compte", "runtime.resetPasswordAction": "Envoyer le lien", "runtime.checkEmailForVerification": "Vérifiez votre courriel pour confirmer votre compte.", "runtime.resetEmailSent": "Lien envoyé. Consultez votre courriel.", "runtime.passwordUpdated": "Mot de passe mis à jour. Reconnectez-vous.", "runtime.updatePasswordAction": "Mettre à jour", "runtime.resetUnavailable": "Impossible de réinitialiser le mot de passe. Réessayez.", "runtime.resetLinkInvalid": "Ce lien est invalide ou expiré.", "runtime.newPassword": "Nouveau mot de passe", "runtime.confirmPassword": "Confirmer le mot de passe", "runtime.passwordMismatch": "Les mots de passe ne correspondent pas.", "runtime.introLogo": "Logo PeacePad", "runtime.skip": "Passer", "runtime.next": "Suivant", "runtime.getStarted": "Commencer"
    ,"production.signInTitle": "Se connecter à PeacePad", "production.signInBody": "Utilisez votre compte PeacePad.",
    "production.regionCanada": "Canada", "production.email": "Courriel", "production.password": "Mot de passe",
    "production.createJoinBody": "Commencez en privé, utilisez une invitation reçue ou connectez l’autre parent quand vous le souhaitez.",
  ...
  es: {
    ...
    "support.title": "Ayuda y soporte", "support.quickHelp": "Encuentra respuestas o contacta con el equipo de soporte de PeacePad.",
    "support.helpCenter": "Centro de ayuda", "support.contact": "Contactar con soporte", "support.privacy": "Privacidad", "support.safety": "Seguridad",
    "support.diagnostic": "ID de diagnóstico: {id}", "support.diagnosticLoading": "Preparando ID de diagnóstico...", "support.openError": "PeacePad no pudo abrir ese enlace.",
    "profile.title": "Perfil", "profile.body": "Elige el nombre que verá tu familia conectada.", "profile.name": "Nombre visible",
    "profile.save": "Guardar perfil", "profile.saving": "Guardando perfil...", "profile.saved": "Perfil guardado.", "profile.error": "PeacePad no pudo actualizar tu perfil.",
    "personality.title": "Perfil de comunicación", "personality.body": "Opcional. Elige un tipo solo si ya lo conoces. PeacePad nunca infiere un tipo sobre ti ni sobre el otro progenitor, y esto no es un diagnóstico.", "personality.notSure": "Aún no estoy seguro", "personality.saving": "Guardando...", "personality.saved": "Perfil de comunicación guardado.", "personality.error": "PeacePad no pudo actualizar tu perfil de comunicación.", "personality.optionHint": "Selecciona este perfil de comunicación opcional.",
    "more.introduction.title": "Volver a ver la introducción", "more.introduction.body": "Vuelve a ver las tres pantallas breves de bienvenida de PeacePad.",
    "notifications.title": "Notificaciones", "notifications.enable": "Activa las alertas de mensajes, calendario y llamadas entrantes.",
    "notifications.enabled": "Las notificaciones están activadas. Toca para desactivarlas.", "notifications.denied": "Las notificaciones están desactivadas en los ajustes de este dispositivo.",
    "notifications.unavailable": "Las notificaciones no están disponibles temporalmente.", "notifications.updating": "Actualizando notificaciones...",
    ...
    "account.leaveFamily": "Salir de esta familia", "account.leaveFamilyBody": "Elimina tu acceso a este espacio familiar.",
    "account.leaveFamilyTitle": "¿Salir de esta familia?", "account.leaveFamilyWarning": "Perderás el acceso. El historial de coordinación compartido seguirá disponible para los demás miembros autorizados y aparecerás como miembro desactivado.",
    "account.leavingFamily": "Saliendo de la familia...", "account.leaveFamilyConfirm": "Salir de la familia",
    ...
    "invite.connectedBody": "Tu conexión parental aprobada ya está activa.", "invite.createCard": "Crear una invitación privada", "invite.createTitle": "Invitar al otro progenitor",
    ...
    "runtime.signingIn": "Iniciando sesión...", "runtime.signIn": "Iniciar sesión", "runtime.chooseFamily": "Elegir un espacio parental", "runtime.chooseFamilyBody": "Selecciona el espacio parental que quieres abrir.",
    "runtime.familyOption": "{family} - {role}", "runtime.createJoin": "Empezar con PeacePad", "runtime.createJoinBody": "Empieza en privado, usa una invitación recibida o conecta al otro progenitor cuando quieras.",
    "runtime.createFamilyTitle": "Conectar al otro progenitor", "runtime.familyName": "Nombre del espacio parental", "runtime.createFamily": "Preparar una invitación privada", "runtime.createConnectionBody": "PeacePad preparará un espacio parental privado sin pedirte que definas tu familia o relación.", "runtime.enterInvite": "¿Tienes un código de invitación?",
    ...
    ,"runtime.connectionReady": "Tu conexión parental está lista. Comparte un código de un solo uso solo cuando tú decidas.", "runtime.continueSolo": "Empezar por mi cuenta", "runtime.inviteLater": "Conectar al otro progenitor más tarde", "runtime.createFamilyWhenReady": "Conectar al otro progenitor más tarde", "runtime.soloTitle": "Tu espacio privado de PeacePad", "runtime.soloBody": "Tu espacio está listo. Usa PeacePad en privado y conecta al otro progenitor solo cuando tú decidas.", "runtime.soloOnboardingBody": "Usa PeacePad en privado desde ahora. Podrás conectar al otro progenitor más tarde; no necesitas una invitación para comenzar.", "runtime.soloPrivateTitle": "Privado de forma predeterminada", "runtime.soloPrivateBody": "Nada se comparte con el otro progenitor. Tú decides si quieres crear una conexión parental y cuándo hacerlo.", "runtime.soloPauseTitle": "Haz una pausa antes de enviar", "runtime.soloPauseBody": "Escribe un borrador privado y compártelo en el canal que te funcione.", "runtime.soloDraftLabel": "Borrador privado", "runtime.soloDraftPlaceholder": "Escribe lo que quieres decir…", "runtime.soloShareDraft": "Compartir borrador", "runtime.soloShareError": "PeacePad no pudo abrir el uso compartido. Inténtalo de nuevo.", "runtime.inviteExpiry": "Caduca en 72 horas. No uses información familiar real en el entorno de pruebas.",
    "runtime.checkConnection": "Comprobar conexión", "runtime.shareInvitation": "Compartir invitación", "runtime.shareInvitationTitle": "Invitación de PeacePad", "runtime.shareInvitationBody": "Revisa la invitación antes de conectarte.", "runtime.shareInvitationCode": "Código: {code}", "runtime.shareInvitationError": "PeacePad no pudo abrir el uso compartido. Usa el código en su lugar.", "runtime.createAccount": "Crear cuenta", "runtime.forgotPassword": "¿Olvidaste tu contraseña?", "runtime.backToSignIn": "Volver a iniciar sesión", "runtime.createAccountTitle": "Crea tu cuenta de PeacePad", "runtime.createAccountBody": "Usa tu correo para crear una cuenta privada de PeacePad.", "runtime.resetPasswordTitle": "Restablecer contraseña", "runtime.resetPasswordBody": "Te enviaremos un enlace seguro.", "runtime.createAccountAction": "Crear cuenta", "runtime.resetPasswordAction": "Enviar enlace", "runtime.checkEmailForVerification": "Revisa tu correo para verificar tu cuenta.", "runtime.resetEmailSent": "Enlace enviado. Revisa tu correo.", "runtime.passwordUpdated": "Contraseña actualizada. Inicia sesión de nuevo.", "runtime.updatePasswordAction": "Actualizar contraseña", "runtime.resetUnavailable": "No pudimos restablecer la contraseña. Inténtalo de nuevo.", "runtime.resetLinkInvalid": "Este enlace no es válido o ha caducado.", "runtime.newPassword": "Nueva contraseña", "runtime.confirmPassword": "Confirmar contraseña", "runtime.passwordMismatch": "Las contraseñas no coinciden.", "runtime.introLogo": "Logotipo de PeacePad", "runtime.skip": "Omitir", "runtime.next": "Siguiente", "runtime.getStarted": "Comenzar"
    ,"production.signInTitle": "Iniciar sesión en PeacePad", "production.signInBody": "Usa tu cuenta de PeacePad.",
    "production.regionCanada": "Canadá", "production.email": "Correo", "production.password": "Contraseña",
    "production.createJoinBody": "Empieza en privado, usa una invitación recibida o conecta al otro progenitor cuando quieras.",
...
const productionKeyOverrides: Readonly<Partial<Record<MessageKey, MessageKey>>> = {
  ...
  "runtime.emailPlaceholder": "production.email",
  "runtime.password": "production.password",
  "runtime.passwordPlaceholder": "production.password",
