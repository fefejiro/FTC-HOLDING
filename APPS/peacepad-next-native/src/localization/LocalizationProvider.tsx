...
const messages = {
  en: {
    ...
    "production.createJoinTitle": "Get started with PeacePad", "production.createJoinBody": "Start privately or connect with an invitation. Invite a co-parent whenever you’re ready.",
    "production.startPrivate": "Start privately", "production.connectInvitation": "Connect with an invitation",
  ...
  fr: {
    ...
    "production.createJoinTitle": "Commencer avec PeacePad", "production.startPrivate": "Commencer en privé", "production.connectInvitation": "Se connecter avec une invitation",
  ...
  es: {
    ...
    "production.createJoinTitle": "Comenzar con PeacePad", "production.startPrivate": "Empezar en privado", "production.connectInvitation": "Conectarse con una invitación",
...
const productionKeyOverrides: Readonly<Partial<Record<MessageKey, MessageKey>>> = {
  ...
  "runtime.createJoin": "production.createJoinTitle",
