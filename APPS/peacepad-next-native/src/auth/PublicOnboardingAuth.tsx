...
const styles = StyleSheet.create({
  ...
  introCopy: { backgroundColor: colors.background, flex: 1, gap: spacing.md, justifyContent: "center", padding: spacing.xl },
  introCopyCompact: { padding: spacing.lg },
  auth: { backgroundColor: colors.background, flexGrow: 1, gap: spacing.md, justifyContent: "center", padding: spacing.xl },
  ...
  input: { backgroundColor: colors.surface, borderColor: colors.border, borderRadius: 18, borderWidth: 1, color: colors.text, fontSize: 16, minHeight: 54, padding: spacing.md },
