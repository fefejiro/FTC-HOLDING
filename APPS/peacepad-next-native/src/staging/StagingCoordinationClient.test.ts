...
test("creates a production client only for the exact authorized Canada project", () => {
  ...
  expect(() => createStagingCoordinationClient({ ...production, apiBaseUrl: "https://rohvkyuxbnqzglaromms.supabase.co/functions/v1/peacepad-v2-api" }, async () => undefined)).toThrow("approved Canada API host");
