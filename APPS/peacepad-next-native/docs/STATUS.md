...
- Verified implementation baseline: `0dc68c746`
...
infrastructure workflows pass for the current explicit queued-message recovery
`0dc68c746` (native run `31345914279`; infrastructure run `31345914358`). The overall PR remains unstable
