...
$arguments = "-WindowStyle Hidden -NoProfile -ExecutionPolicy Bypass -File `"$runnerPath`" -ProjectRoot `"$projectPath`" -WorktreeRoot `"$worktreePath`" -StateRoot `"$statePath`" -MaxRunsPerDay $MaxRunsPerDay -MaxMinutes $MaxMinutes"
