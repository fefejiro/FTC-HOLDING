...
export const demoModules: DemoModule[] = [
  {
    ...
    product: 'Una Labs',
    title: 'From request to plan selection',
    description:
      'A walkthrough of the public Una Labs flow from `/start` into the scoped summary and live Stripe handoff.',
    placeholder: 'Drop in the Loom that shows the intake form, plan picker, and summary screen.',
    bullets: [
      'Show the two-step intake flow on `unalabs.cloud/start`.',
      'Capture the summary and pricing review on `/start/summary`.',
      'End at the Stripe redirect so the live commercial path is obvious.',
    ],
    cta: { label: 'Start the intake flow', href: '/start' },
  },
  {
    slug: 'dispatch',
    label: 'Delivery Tracking',
    product: 'Dispatch',
    title: 'Live request handling and operator state',
    description:
      'A real operational walkthrough showing how Dispatch handles requests, queue state, and customer-facing progress.',
    placeholder: 'Drop in the Loom that shows request submission, operator queue movement, and status changes.',
    bullets: [
      'Show the customer request entering the flow.',
      'Show the operator-facing queue or status management surface.',
      'End with the customer-facing progress result.',
    ],
  ...
  },
  {
    ...
    label: 'AI Automation',
    product: 'PeacePad',
    title: 'Trust-sensitive product flow',
    description:
      'A walkthrough focused on calm UX, guided product flow, and real AI-backed customer interaction.',
    placeholder: 'Drop in the Loom that shows the web flow, extension, or another trust-heavy PeacePad path.',
    bullets: [
      'Show the product context that makes the UX feel human and deliberate.',
      'Capture one meaningful interaction, not just a landing-page scroll.',
      'Tie the walkthrough back to the kind of systems Una Labs can build for clients.',
    ],
  ...
  },
  {
    ...
    label: 'Product Depth',
    product: 'Saywetin',
    title: 'AI product work beyond brochure sites',
    description:
      'A walkthrough that demonstrates real product capability in language and culture intelligence.',
    placeholder: 'Drop in the Loom that shows recognition, interpretation, or another live Saywetin flow.',
    bullets: [
      'Capture the moment where the product promise becomes obvious.',
      'Keep the recording short and concrete.',
      'Use it as proof that Una Labs ships product-grade AI surfaces.',
    ],
...
export const proofHighlights = [
  {
    value: '4',
    label: 'Live products',
    note: 'Una Labs, Dispatch, PeacePad, and Saywetin are already deployed.',
  },
  {
    value: 'CAD',
    label: 'Live billing path',
    note: 'The public Una Labs intake already flows into real Stripe checkout.',
  },
  {
    value: '14-day',
    label: 'Trial activation',
    note: 'Customers can move from request to activated trial without a sales call.',
  },
];
