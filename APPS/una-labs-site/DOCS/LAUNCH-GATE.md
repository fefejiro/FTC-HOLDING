...
- [ ] Contract status is signed/accepted
...
- [ ] Client has been sent briefing/report/proposal links
...
- [ ] Support contact path is documented for client
...
- [ ] No new TypeScript warnings/errors introduced by launch changes
