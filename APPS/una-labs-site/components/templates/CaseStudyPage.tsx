          ...
          <div className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
            <div className="max-w-2xl">
              ...
              <p className="mt-4 text-body-sm text-tx-muted">
                Live URL: <a className="text-brand-teal hover:underline" href={study.liveUrl} target="_blank" rel="noreferrer">{study.liveUrl}</a>
              </p>
            </div>
      ...
      <section className="bg-white py-20">
        <div className="max-w-content mx-auto px-6">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-4 text-h2 text-tx-heading">Real product work already in market</h2>
            <p className="mt-4 text-body-lg leading-relaxed text-tx-secondary">
