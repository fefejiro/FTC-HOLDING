...
|---|---------|--------|-------------|---------------|-------------|
| 1 | **Tow Signal** | Live (Ottawa) | ~$5 USD Railway | Paying clients: Kevin, Cheta | Repair public routing, run smoke test, fix failures |
...
**Total monthly burn:** ~$10 USD ($5 Railway Tow Signal internal Dispatch runtime + $5 Railway PeacePad) + $10 USD GitHub Copilot Pro = **$20 USD/month**
...
|---------|----------|---------|--------|
| Tow Signal | Cloudflare Worker + web app | Railway (live, internal service name `dispatch-api`) | dispatch.unalabs.cloud |
...
**Project:** Tow Signal reliability + rebrand hardening
**Goal:** Restore public uptime, finish the Tow Signal naming pass, and polish the premium roadside UX before feature expansion
**Success:** public routing healthy, Tow Signal visible across docs and key surfaces, smoke tests passing
**Do not work on:** new feature expansion before reliability and rebrand basics are stable
...
```powershell
# Tow Signal smoke test (internal Dispatch repo path)
...
| Tow Signal context | APPS/dispatch/DOCS/CONTEXT.md |
| Tow Signal decisions | APPS/dispatch/DOCS/DECISIONS.md |
| Tow Signal velocity | APPS/dispatch/DOCS/VELOCITY_LOG.md |
| Tow Signal UI rebuild plan | APPS/dispatch/DOCS/TOWSIGNAL_UI_REBUILD_PLAN.md |
...
> I am Manchi, solo founder of Fejiro Technology Consultancy Inc. (FTC Holding / Una Labs). Stack: React, React Native, Node.js, Next.js, Supabase, Cloudflare, Railway. Projects: Tow Signal (public brand, internal repo/runtime still Dispatch, live, paying clients), PeacePad (live), OG Trades Academy (pre-launch), ATEAM (internal), SayWetin (live), GuardSignal (pre-build). Principles: optimize existing systems first, minimize burn, defer paid services until revenue-positive, 70% planning 30% building. IDE: VS Code on Windows. No contractions, no em dashes, direct tone. Lean, revenue-first solutions always. Active sprint: Tow Signal reliability hardening and premium rebrand pass.
...
- Updated at: 2026-05-04T04:09:03.979Z
