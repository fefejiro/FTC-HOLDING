...
Generated: 2026-06-16T01:30:40.942Z
Root: `C:\FTC HOLDING`
...
- P0 Railway account: Fix Railway account billing/token authorization before attempting Railway service or domain changes. Evidence: ERRORS: [{"message":"Not Authorized","locations":[{"line":1,"column":9}],"path":["me"],"extensions":{"code":"INTERNAL_SERVER_ERROR"},"traceId":"3072143828697238921"}]
...
| PASS | saywetin npm run check | Command completed. |
| PASS | saywetin npm run build:prod | Command completed. |
| PASS | dispatch npm run check | Command completed. |
