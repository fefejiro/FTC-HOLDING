...
Generated: 2026-06-16T00:58:12.807Z
Root: `C:\FTC HOLDING`
...
- P0 Railway account: Fix Railway account billing/token authorization before attempting Railway service or domain changes. Evidence: ERRORS: [{"message":"Not Authorized","locations":[{"line":1,"column":9}],"path":["me"],"extensions":{"code":"INTERNAL_SERVER_ERROR"},"traceId":"5799819427479760308"}]
...
| FAIL | Ops private console | Content-Type expected text/html, got -. |
| FAIL | ATEAM public surface | Content-Type expected text/html, got -. |
