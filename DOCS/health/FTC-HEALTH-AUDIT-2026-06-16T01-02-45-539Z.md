...
Generated: 2026-06-16T01:02:45.538Z
Root: `C:\FTC HOLDING`
...
- P0 Railway account: Fix Railway account billing/token authorization before attempting Railway service or domain changes. Evidence: ERRORS: [{"message":"Not Authorized","locations":[{"line":1,"column":9}],"path":["me"],"extensions":{"code":"INTERNAL_SERVER_ERROR"},"traceId":"960837159728997874"}]
...
- P1 Local app owners: Resolve failing local build/test gates before calling the corresponding app locally healthy. Evidence: gardencleaners-site npm run build: Command exited 1. \| peacepad npm run check: Command exited 2. \| peacepad npm run build:frontend: Command exited 1. \| peacepad npm run build:api: Command exited 1. \| saywetin npm run check: Command exited 2. \| saywetin npm run build:prod: Command exited 1.
...
| Status | Check | Summary |
|---|---|---|
| PASS | local gate mode | Deep local build/test gates enabled. |
| PASS | anion npm run check | Command completed. |
| PASS | anion npm run test | Command completed. |
| PASS | anion npm run build | Command completed. |
| PASS | ftc-site npm run build | Command completed. |
| FAIL | gardencleaners-site npm run build | Command exited 1. |
| PASS | capsigma-growth-desk npm run check | Command completed. |
| FAIL | peacepad npm run check | Command exited 2. |
| FAIL | peacepad npm run build:frontend | Command exited 1. |
| FAIL | peacepad npm run build:api | Command exited 1. |
| FAIL | saywetin npm run check | Command exited 2. |
| FAIL | saywetin npm run build:prod | Command exited 1. |
| FAIL | dispatch npm run check | Command exited 2. |
| FAIL | dispatch npm run build | Command exited 1. |
