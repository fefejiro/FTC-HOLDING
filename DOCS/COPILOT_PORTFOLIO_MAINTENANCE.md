...
3. When `COPILOT_ASSIGN_TOKEN` is configured and its owner has GitHub Copilot coding-agent access, the script assigns the issue to Copilot. Without it, the issue is marked `blocked` with the exact setup requirement.
